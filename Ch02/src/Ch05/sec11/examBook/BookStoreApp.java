...
public class BookStoreApp {
	...
	public static void main(String[] args) {
		...
		bookArray[0] = BookService.makeBook("comic","열혈강호","정극진,양재현","대원씨아이",4500,"979-11-5754-926-9");
		...
		bookArray[4] = BookService.makeBook("food","버번 위스키의 모든 것","조승원","(주)교육당",24000,"979-11-90277-42-6");
